...
const Footer = () => {
    ...
    return (
        <footer className='bg-theme-dark bg-gray-900 pt-20 lg:pt-32 text-white px-[15px] lg:px-0'>
            <div className='container mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5'>
                    <div className='lg:col-span-2 mb-b-30 lg:mb-0'>
                        <img src={img} alt="" className='w-40 h-20 mb-5' />
                        <p className='text-[#E8E8E8] text-base leading-6 font-normal mb-5 lg:w-2/3'>Resale Product is one of the best premium sites. Here we provide the best products. We believe in 100% customer satisfaction.</p>
                    ...
                    <div className='mb-b-30 lg:mb-0'>
                        ...
                        <ul>
                            ...
                            <li>
                                <Link className='text-base font-normal text-[#F3F3F3] leading-10' to='/blogs'>Blogs</Link>
                            </li>
                        </ul>
                    </div>
                    <div className='mb-b-30 lg:mb-0'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5 mt-20 pb-16'>
                    ...
                    <p className='text-center md:text-right'>Developed & Maintained By  <a href='https://www.facebook.com/abnaeembsc' className='text-theme-default' target={'_blank'} rel="noreferrer">Faisal Ahmed.</a></p>
                </div>
            </div>
        </footer>
    );
